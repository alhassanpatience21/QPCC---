                    ...
                    <table id="file_export" class="file_export table table-striped table-bordered display">
                        <thead>
                            <tr>
                                ...
                                <th class="text-dark font-weight-bold text-center">Sms Status</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <b>
                                        ...
                                        <span style="color: green"><i class="fa fa-check-circle"></i> Suscribed</span>
                                        @else
                                        <span class="text-danger"><i class="fa fa-info-circle"></i> Not Suscribed</span>
                                        @endif
                                    </b>
                                </td>
