    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="card-title"> @yield('title') <span class="badge badge-pill badge-success">{{ $accounts->count() }}</span></h3>
                    </div>
                </div><hr>
                    ...
                    <table id="file_export" class="file_export table table-striped table-bordered display">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-success"><b>GHS {{ number_format($deposit->balance,2) }}</b></td>
